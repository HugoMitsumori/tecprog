...
- Controle de visualização de cristais e remoção do robô (Fase 3)
...
* O robô será criado por padrão com as instruções contidas nos arquivos "programa1", "programa2", "programa3" e "programa4",
relativo aos times (time 1 carrega programa1, e assim em diante)
Caso não exista o arquivo específico do time, irá carregar um genérico "programa"
...
base <caminho_sprite> <i> <j> : adiciona a base com as posições dadas na lista de bases
cristal <quantidade> <i> <j> : adiciona os cristais com as posições dadas na lista de cristais
